...
class Assignment_3B_FairSemaphoreWhiteBoxCOTest : AssignmentTests(timeoutSeconds = 60) {
    @Mock
    ...
    /**
     * TODOx: This test will sometimes fail due to thread
     * interrupt flag not being reset before test completes.
     */
    @Test
    fun testAcquireUninterruptiblyWithInterrupt() {
        ...
        // TODOx: sometimes fails even when there is no bug in source code implementation.
