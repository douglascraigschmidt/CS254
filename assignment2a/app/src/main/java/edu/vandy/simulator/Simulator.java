 ...
 * <p>
 * This class also acts as a sink for all component {@link #throwError} and
...
public class Simulator
     ...
     */
    public PalantiriManager mPalantiriManager;
    /**
    ...
    public Simulator(ModelObserver observer) {
        ...
        super(SimulatorModel.Type.SIMULATOR, IDLE, null);
     ...
     *
     * @param beingManagerType
     * @param palantiriManagerType
     * @param beingCount           The number of Beings.
     * @param palantirCount        The number of Palantiri.
     * @param threadCount          The number of threads to use in simulation.
    ...
    public void buildModel(BeingManager.Factory.Type beingManagerType,
        ...
        if (mBeingManager == null
                || !mBeingManager.getClass().getSimpleName().equals(beingManagerType.getCanonicalName())
    ...
    public Palantir acquirePalantir(Being being) {
        ...
        if (palantir != null) {
            ...
            if (being.getPalantirId() != -1L) {
                ...
                throwError("Being is already gazing at another palantir.");
            }
            ...
            if (palantir.getBeingId() != -1L) {
                ...
                throwError("Palantir is still owned by another being.");
            }
            ...
            throwError("Simulator#acquirePalantir was unable to acquire a palantir!");
        }
    ...
    public void releasePalantir(Being being, Palantir palantir) {
        if (palantir != null) {
            ...
            throwError("Simulator#releasePalantir called with a null palantir!");
        }
    }
    ...
    public void reset() {
        try {
            ...
            throwError("Reset must never throw an exception - fix this!: " + e);
        }
    }
     ...
     * base class overloaded {@link #throwError} methods which will route
     ...
     */
    public void throwError(@Nullable String msg, Object... args) {
        // Format string if args are passed.
        if (msg == null) {
     ...
     */
    public void throwError(@NotNull Throwable throwable) {
                ...
                modelSnapshot.getBeings().values().stream()
                        ...
                        .forEach(b -> {
                            ...
                            if (ps.getBeingId() != b.getId()) {
                                throwError("FRAMEWORK SYNCHRONIZATION ERROR!");
                            }
                        });
            }
     ...
     */
    public void incrementGazingCountAndCheck(long beingId,
                                             Palantir palantir) {
     ...
     */
    public void decrementGazingCount() {
