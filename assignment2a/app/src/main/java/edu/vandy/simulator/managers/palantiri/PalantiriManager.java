...
public abstract class PalantiriManager
     ...
     *                 the Palantir pool.
     */
    protected abstract void release(Palantir palantir) throws InterruptedException;
    ...
    /**
     * Should be called periodically to determine if a shutdown has
     * been requested. This method should be called at a relatively
     * fine-grained interval to ensure responsive shutdown requests.
     *
    ...
    public static class Factory {
        ...
        public enum Type {
            ...
            FAIR_STAMPED_LOCK("stampedLockFairSemaphore.StampedLockFairSemaphoreMgr"),
