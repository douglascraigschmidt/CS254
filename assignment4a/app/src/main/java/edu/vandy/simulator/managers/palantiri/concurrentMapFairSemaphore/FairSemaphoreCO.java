...
public class FairSemaphoreCO
    ...
    /**
     * Define a monitor lock (using a Lock) to protect critical
     * sections.  This lock's synchronization semantics should be
     * "non-fair".
     */
    ...
    protected boolean tryToGetPermit() {
        ...
        // solution that performs synchronization and then just
        // forward to tryToGetPermitUnlocked(), which contains the
        // actual logic for checking if a permit can be obtained.
        return false;
    }
    ...
    protected boolean tryToGetPermitUnlocked() {
        ...
        // should contain the actual logic for checking if a permit
        // can be obtained.
        return false;
    }
